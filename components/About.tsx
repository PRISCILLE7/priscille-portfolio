    ...
    <GridWrapper id="about">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_290px] gap-12 items-start">
        ...
        >
          ...
          <p>Over the past 4 years, I have contributed to the development and industrialization of AI solutions across multiple sectors, from computer vision systems for retail execution and field intelligence to predictive maintenance and fault diagnosis in industrial equipment. My work spans the complete AI lifecycle: data collection and annotation, model development, experimentation, deployment, monitoring, continuous improvement, and MLOps.</p>
